...
func (mr *MockIHttpClientMockRecorder) DeleteMarshalReturnObj(url, obj interface{}) *gomock.Call {
...
func (mr *MockIHttpClientMockRecorder) GetMarshalReturnObj(url, obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
